  ...
  const content = (
    <div className="fixed inset-0 z-50 flex flex-col bg-background overflow-hidden w-full max-w-full">
      ...
      <div className="flex-1 w-full max-w-full overflow-y-auto overscroll-contain px-[11px]">
        <div
          className={cn("mx-auto pb-8 w-full max-w-full box-border", isMobile ? "px-2 py-3" : "max-w-4xl px-6 py-6")}
        >
            ...
            {showMappingSection && (
              <Collapsible open={sectionsOpen.mapping} onOpenChange={() => toggleSection("mapping")}>
                <Card className="border-border">
                  <CollapsibleTrigger asChild>
                    ...
                    >
                      <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                          <h3
                            className={cn("font-medium text-foreground truncate", isMobile ? "text-sm" : "text-base")}
                          >
                            Column Mapping
                          </h3>
                          <p className={cn("text-muted-foreground truncate", isMobile ? "text-[10px]" : "text-xs")}>
                  ...
                  <CollapsibleContent>
                    <CardContent
                      className={cn("pt-0 overflow-hidden w-full max-w-full", isMobile ? "pb-3 px-4" : "pb-4 px-4")}
                    >
                  ...
                  <CollapsibleTrigger asChild>
                    ...
                    >
                      ...
                      {sectionsOpen.preview ? (
                        ...
                        <ChevronDown
                          className={cn("text-muted-foreground shrink-0", isMobile ? "h-4 w-4" : "h-5 w-5")}
                        />
                      )}
                    </div>
                  </CollapsibleTrigger>
