...
const mainNavItems = [
  ...
  { to: '/package-labels', icon: Tag, label: 'Package Labels' },
];

const managementItems = [
  { to: '/track', icon: MapPin, label: 'Tracking' },
    ...
    <Sidebar collapsible="icon" className="border-r border-border">
        ...
        <div className="flex items-center gap-3">
          ...
          {!collapsed && (
            <div className="flex flex-col">
              <span className="font-semibold text-foreground">PharmaNet</span>
      ...
      <SidebarFooter className="p-4 mt-auto">
        ...
        <button
          ...
          className={`mt-3 flex items-center gap-2 px-3 py-2 rounded-lg text-destructive hover:bg-destructive/10 transition-colors w-full ${collapsed ? 'justify-center' : ''}`}
        >
