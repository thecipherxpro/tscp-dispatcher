...
interface CustomLabelGeneratorDialogProps {
  orders: CustomOrder[];
  isOpen: boolean;
  onClose: () => void;
}
...
export function CustomLabelGeneratorDialog({ orders, isOpen, onClose }: CustomLabelGeneratorDialogProps) {
              ...
              >
                <CardContent className="p-4 flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Labels with custom shipped date/time (shown on PDF only)
                    </p>
                  </div>
                  <ArrowRight className="w-5 h-5 text-muted-foreground" />
                </CardContent>
              ...
              >
                <CardContent className="p-4 flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Labels with shipped + delivered dates and "COMPLETED" stamp
                    </p>
                  </div>
                  <ArrowRight className="w-5 h-5 text-muted-foreground" />
                </CardContent>
                  ...
                  <div className="text-xs text-muted-foreground space-y-1">
                    ...
                    {labelType === 'completed' && (
                      <>
                        ...
                        <p className="text-green-600 font-medium">• "COMPLETED" stamp will be added</p>
                      </>
                    )}
                  </div>
                </CardContent>
