...
import { Package, Truck, Shield, Clock, Search, ArrowRight, MapPin, CheckCircle } from 'lucide-react';
...
const features = [
  {
    ...
    description: 'Follow your delivery every step of the way with live status updates.',
  },
  {
    icon: Shield,
    title: 'Secure & Confidential',
    description: 'Your health information is protected with industry-leading privacy standards.',
  },
  {
    icon: Clock,
    title: 'Fast Delivery',
    description: 'Same-day and next-day delivery options available across service areas.',
  },
  {
    icon: MapPin,
    title: 'Door-to-Door Service',
    description: 'Professional drivers deliver directly to your specified address.',
  },
];
      ...
      <nav className="border-b border-border bg-card/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src={endoverdoseLogo} alt="TSCP" className="h-9 w-9 rounded-lg" />
            <span className="font-bold text-lg text-foreground tracking-tight">TSCP Dispatch</span>
          </div>
          <div className="flex items-center gap-3">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              TSCP Dispatch provides secure, confidential prescription delivery right to your door. 
              Track your order in real-time with complete peace of mind.
            </p>
            ...
            <div className="max-w-md mx-auto">
              ...
              <p className="text-xs text-muted-foreground mt-3">
                Enter your tracking ID (e.g., 123T45S67CP) to see live delivery status
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground tracking-tight">
              Why Choose TSCP Dispatch
            </h2>
            <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
              Professional, secure, and reliable prescription delivery you can trust.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
              From pharmacy to your doorstep — simple, secure, and transparent.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <section className="py-20 bg-primary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          ...
          <p className="text-lg text-primary-foreground/80 max-w-2xl mx-auto">
            Enter your tracking ID to get real-time updates on your prescription delivery.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6 text-sm text-muted-foreground">
              <Link to="/TrackShipment" className="hover:text-foreground transition-colors">
                Track Order
              </Link>
            ...
            <p className="text-xs text-muted-foreground">
              © {new Date().getFullYear()} TSCP Dispatch. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
